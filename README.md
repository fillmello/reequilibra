...
Deve ser adicionada uma aba para agendamento de consultas com profissionais da área, incluindo desde o pagamento até a interação com uma plataforma de comunicação em tempo real.

##### Funcionalidade 3 - Fórum
Os clientes terão a possibilidade de abrir tópicos sobre questões nas quais sentem dificuldades e interagir com os psicólogos cadastrados e verificados pela plataforma.